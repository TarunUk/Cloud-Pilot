...
export const MonitoringSection: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] md:w-[1200px] h-[580px] bg-gradient-to-r from-telemetry/18 via-brand-500/10 to-transparent blur-[190px] rounded-full pointer-events-none -z-10" />
      <div className="absolute bottom-1/4 right-1/4 w-[480px] h-[480px] bg-telemetry/12 blur-[160px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="rounded-2xl border border-border bg-surface-card/90 p-6 sm:p-10 md:p-12 shadow-3d-deep backdrop-blur-xl relative rim-light transition-colors duration-300">
          ...
          <div className="hidden sm:flex items-center gap-2 px-3.5 py-1 rounded-full bg-telemetry/15 border border-telemetry/30 text-xs font-mono text-telemetry-light absolute -top-3.5 right-8 shadow-satellite-pill backdrop-blur-md">
            <span className="w-1.5 h-1.5 rounded-full bg-telemetry-light animate-pulse" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="flex items-center justify-between text-xs font-mono">
                ...
                <span className="text-telemetry-light font-semibold">0.4ms Ingest • P99: 14ms</span>
              </div>
              ...
              <div className="h-44 sm:h-48 w-full relative pt-2">
                <svg viewBox="0 0 400 120" className="w-full h-full overflow-visible" preserveAspectRatio="none">
                  ...
                  />
                  <circle cx="400" cy="45" r="4.5" fill="#38BDF8" className="animate-ping" />
                  <circle cx="400" cy="45" r="4" fill="#06B6D4" />
                </svg>
              </div>
              ...
              <div className="flex justify-between text-[11px] font-mono text-muted-text pt-2 border-t border-border">
                ...
                <span className="text-brand-500 dark:text-brand-400 font-semibold">99.99% Reliability</span>
              </div>
            </div>
