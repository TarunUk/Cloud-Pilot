...
export const Hero: React.FC = () => {
  return (
    <section className="relative pt-44 pb-28 md:pt-56 md:pb-40 overflow-hidden bg-bg-hero">
      ...
      <div className="absolute top-1/4 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[700px] md:w-[1000px] h-[480px] bg-gradient-to-tr from-brand-500/12 via-infra/10 to-transparent blur-[180px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="absolute inset-0 pointer-events-none opacity-15 flex items-center justify-center -z-10">
        <svg className="w-full max-w-5xl h-[450px] animate-float-gentle" viewBox="0 0 1000 450" fill="none">
          <ellipse cx="500" cy="225" rx="380" ry="130" stroke="url(#heroOrbitGrad2)" strokeWidth="1.5" strokeDasharray="6 8" />
          ...
          <defs>
            <linearGradient id="heroOrbitGrad2" x1="120" y1="95" x2="880" y2="355" gradientUnits="userSpaceOnUse">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-[#0E1322]/80 border border-white/[0.08] shadow-satellite-pill text-xs font-mono text-slate-300 mb-8 backdrop-blur-md rim-light">
