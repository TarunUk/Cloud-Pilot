...
export const HowItWorks: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Ambient Lighting */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[850px] md:w-[1100px] h-[450px] bg-gradient-to-r from-[#C069FF]/18 via-[#EC4899]/15 to-[#D946EF]/15 blur-[180px] rounded-full pointer-events-none -z-10" />
