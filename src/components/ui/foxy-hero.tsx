...
export interface FoxyHeroProps {
  logo?: {
...
export function FoxyHero({
  ...
  ctaButtons,
  dashboardImage,
  trustedByText = "Trusted by Leading Crypto Platforms",
  className,
  children,
}: FoxyHeroProps) {
        ...
        >
          ...
          <nav className="hidden lg:flex flex-row items-center" style={{ gap: "28px" }} aria-label="Main navigation">
            {navigation?.map((item, index) => {
              ...
              if (item.href) {
                return (
                  <a key={index} href={item.href} onClick={item.onClick} className="inline-block">
                    {content}
                  </a>
                );
              }
              ...
              return (
                <button
                  ...
                  type="button"
                  className="transition-opacity hover:opacity-100 bg-transparent border-0 cursor-pointer p-0"
                >
                  {content}
                </button>
              );
          ...
          {headerCta && (
            headerCta.href ? (
              <a
                ...
                className="flex flex-row justify-center items-center transition-all hover:scale-105 no-underline"
                style={{
                  padding: "6px 16px",
                  width: "160px",
                  height: "41px",
      ...
      {children ? (
        ...
        <motion.div
          ...
          style={{
            ...
            gap: "41px",
            marginTop: hideHeader ? "110px" : "145px",
          }}
        >
          {/* Title and Subtitle */}
