...
export const DeploySection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] md:w-[1200px] h-[580px] bg-gradient-to-r from-violet/18 via-infra/15 to-transparent blur-[190px] rounded-full pointer-events-none -z-10" />
      <div className="absolute top-1/3 left-1/4 w-[480px] h-[480px] bg-violet/12 blur-[160px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="rounded-2xl border border-border bg-surface-card/90 p-6 sm:p-10 md:p-12 shadow-3d-deep backdrop-blur-xl relative rim-light transition-colors duration-300">
          ...
          <div className="relative mb-12 pt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6 relative z-10">
              {steps.map((step, idx) => (
                ...
                >
                  <div className="w-11 h-11 rounded-2xl bg-surface-secondary border border-border flex items-center justify-center font-mono text-xs font-bold text-foreground shadow-satellite-pill shrink-0 group-hover:border-violet-light group-hover:scale-105 transition-all">
                    <span className="text-violet-light font-bold">0{idx + 1}</span>
                  </div>
                  <div>
          ...
          <div className="pt-8 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4 font-mono text-xs">
            ...
            <span className="text-brand-500 dark:text-brand-400 font-semibold">Uptime: 100%</span>
          </div>
        </div>
      </div>
