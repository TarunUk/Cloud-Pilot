...
export const FinalCTA: React.FC = () => {
  return (
    <section className="relative py-32 md:py-48 bg-bg-cta overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 w-[700px] md:w-[1000px] h-[450px] bg-brand-500/15 blur-[190px] rounded-full pointer-events-none -z-10" />
      <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[600px] md:w-[900px] h-[420px] bg-infra/15 blur-[180px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        {/* Status Indicator */}
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface-card/90 border border-border shadow-satellite-pill text-xs font-mono text-brand-500 dark:text-brand-400 mb-8 backdrop-blur-md rim-light">
